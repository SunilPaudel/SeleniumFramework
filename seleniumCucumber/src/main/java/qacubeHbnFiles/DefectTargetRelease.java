...
/**
 * DefectTargetRelease generated by hbm2java
 */
@Entity
@Table(name = "DEFECT_TARGET_RELEASE", schema = "QACUBE_IMPORT_STAGE", uniqueConstraints = @UniqueConstraint(columnNames = {
		"RELEASE_ID", "PROJECT_ID", "DEFECT_ID" }))
public class DefectTargetRelease implements java.io.Serializable {

	private DefectTargetReleaseId id;
	private Defect defect;
	private Project project;
	private ProjectRelease projectRelease;

	public DefectTargetRelease() {
	}

	public DefectTargetRelease(DefectTargetReleaseId id, Defect defect, Project project) {
		this.id = id;
		this.defect = defect;
	...
	public DefectTargetReleaseId getId() {
		return this.id;
	}

	public void setId(DefectTargetReleaseId id) {
		this.id = id;
	}
