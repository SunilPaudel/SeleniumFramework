...
/**
 * DefectDetectedReleaseId generated by hbm2java
 */
@Embeddable
public class DefectDetectedReleaseId implements java.io.Serializable {

	private BigDecimal releaseId;
	private BigDecimal projectId;
	private BigDecimal defectId;

	public DefectDetectedReleaseId() {
	}

	public DefectDetectedReleaseId(BigDecimal releaseId, BigDecimal defectId) {
		this.releaseId = releaseId;
		this.defectId = defectId;
	}

	public DefectDetectedReleaseId(BigDecimal releaseId, BigDecimal projectId, BigDecimal defectId) {
		this.releaseId = releaseId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DefectDetectedReleaseId))
			return false;
		DefectDetectedReleaseId castOther = (DefectDetectedReleaseId) other;
